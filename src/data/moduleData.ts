    ...
    lessons: [
      {
        ...
        duration: "20 min",
        content: `
          <h3>Welcome to Tailoring Fundamentals!</h3>
          <p>Every great tailor starts with the right tools. Quality tools not only make your work easier but also ensure professional results that will last for years.</p>
          ...
          <h4>Pressing Equipment</h4>
          <p>Pressing is crucial in tailoring - it's what separates amateur from professional work:</p>
          <ul>
          ...
          <h4>Pro Tips from Craftsy Experts:</h4>
          <ul>
            <li>Invest in quality shears - they'll last decades with proper care</li>
            <li>Keep tools organized and clean for consistent results</li>
            <li>Start with basic tools and build your collection over time</li>
      ...
      },
      {
        ...
        duration: "25 min",
        content: `
          <h3>The Foundation of Great Garments: Fabric Selection</h3>
          <p>Understanding fabric is crucial for successful tailoring. Each fabric behaves differently during construction and wear, making proper selection essential for your project's success.</p>
          ...
          <h4>Grain Lines & Fabric Behavior</h4>
          <ul>
          ...
          <h4>Fabric Preparation Tips</h4>
          <ul>
            <li>Always pre-wash fabrics that will be washed later</li>
            <li>Press fabric before cutting for accurate measurements</li>
            <li>Check for fabric flaws before cutting</li>
      ...
      },
      {
        ...
        duration: "30 min",
        content: `
          <h3>The Art of Accurate Measurements</h3>
          <p>Proper measurements are the foundation of well-fitting garments. Even the most beautiful construction will fail if the measurements are incorrect.</p>
          
          <h4>Essential Equipment</h4>
          <ul>
            <li>Flexible measuring tape</li>
            <li>String or narrow elastic for marking waistline</li>
            <li>Notepad for recording measurements</li>
            <li>Mirror for checking tape position</li>
          </ul>
          
          <h4>General Guidelines</h4>
          <ul>
            <li>Wear well-fitted undergarments or form-fitting clothes</li>
            <li>Stand naturally with arms at sides</li>
            <li>Keep tape measure snug but not tight</li>
            <li>Take measurements over clothes you'll typically wear under the garment</li>
          ...
          <h5>For Different Body Types</h5>
          <ul>
          ...
          <ul>
            ...
            <li>Keep a measurement chart for regular clients</li>
            <li>Update measurements periodically as bodies change</li>
          </ul>
          
          <h4>Common Measurement Mistakes</h4>
          <ul>
            <li>Taking measurements too tightly</li>
            <li>Not keeping tape level</li>
            <li>Measuring over bulky clothing</li>
            <li>Forgetting to record measurements immediately</li>
    ...
    lessons: [
      {
        ...
        content: `
          ...
          <p>Pattern blocks are the foundation of all garment design. They're basic templates that fit the body closely and serve as the starting point for all other patterns.</p>
          
          <h4>What are Pattern Blocks?</h4>
          <ul>
            <li>Close-fitting templates based on body measurements</li>
            <li>Have minimal ease for movement only</li>
            <li>Contain no style lines or design details</li>
            <li>Used as the basis for creating styled patterns</li>
          </ul>
          
          <h4>Types of Basic Blocks</h4>
          ...
          <h4>Creating Your First Bodice Block</h4>
          
          <h5>Required Measurements</h5>
          <ul>
            <li>Bust circumference</li>
          ...
          <h4>Ease in Pattern Blocks</h4>
          
          <h5>Wearing Ease (Essential)</h5>
          <ul>
            <li>Bust/Chest: 3-4 inches</li>
            <li>Waist: 1-2 inches</li>
            <li>Hips: 2-3 inches</li>
            <li>Upper arm: 1-2 inches</li>
          </ul>
          
          <h5>Design Ease (Added Later)</h5>
          <ul>
            <li>Added during pattern development</li>
            <li>Determines garment silhouette</li>
            <li>Varies by style and designer preference</li>
          </ul>
          
          <h4>Testing Your Block</h4>
          <ul>
            <li>Make a test garment (toile/muslin)</li>
            <li>Use inexpensive fabric similar in weight to final fabric</li>
            <li>Check fit at all key points</li>
            <li>Adjust block as needed</li>
            <li>Keep detailed notes of adjustments</li>
          </ul>
          
          <h4>Common Block Adjustments</h4>
          
          <h5>Full Bust Adjustment (FBA)</h5>
          <ul>
            <li>For bust larger than pattern size</li>
            <li>Adds width and adjusts dart size</li>
            <li>Maintains proper armhole fit</li>
          </ul>
          
          <h5>Shoulder Adjustments</h5>
          <ul>
            <li>Narrow/broad shoulders</li>
            <li>Forward/square shoulders</li>
            <li>Sloping/square shoulder angle</li>
          </ul>
          
          <h5>Length Adjustments</h5>
          <ul>
            <li>Lengthen/shorten torso</li>
            <li>Adjust for posture differences</li>
            <li>Modify for proportion preferences</li>
          </ul>
          
          <h4>Professional Tips</h4>
          <ul>
            <li>Create blocks in your most common size first</li>
            <li>Use quality pattern paper for durability</li>
            <li>Label all pieces clearly</li>
            <li>Store blocks flat or rolled</li>
      ...
      },
      {
        ...
        duration: "40 min",
        content: `
          <h3>From Basic Block to Stylish Design</h3>
          <p>Pattern manipulation is where creativity meets technical skill. Learn to transform your basic blocks into unlimited design possibilities.</p>
          
          <h4>Fundamental Manipulation Techniques</h4>
          
          <h5>Dart Manipulation</h5>
          <ul>
          ...
          <h4>Design Line Development</h4>
          
          <h5>Princess Seams</h5>
          <ul>
            <li>Curved seams from shoulder or armhole to hem</li>
            <li>Eliminates waist darts</li>
            <li>Creates flattering vertical lines</li>
            <li>Process: Draw curved line, split pattern, add seam allowances</li>
          </ul>
          
          <h5>Empire Waistlines</h5>
          <ul>
            <li>Raised waistline under bust</li>
            <li>Separates bodice and skirt sections</li>
            <li>Flattering for many body types</li>
            <li>Process: Mark new waistline, add gathering or pleats to skirt</li>
          </ul>
          
          <h5>Yokes</h5>
          <ul>
            <li>Separate fitted upper sections</li>
            <li>Can be straight, curved, or angled</li>
            <li>Allows for fabric play and design interest</li>
            <li>Process: Draw yoke line, separate pieces, add gathering below</li>
          </ul>
          
          <h4>Sleeve Modifications</h4>
          
          <h5>Sleeve Length Variations</h5>
          <ul>
          ...
          <h4>Neckline Modifications</h4>
          
          <h5>Popular Neckline Styles</h5>
          <ul>
          ...
          <h5>Neckline Development Process</h5>
          <ol>
            <li>Mark desired neckline on pattern</li>
            <li>Smooth curves with French curve</li>
            <li>Check that neckline will go over head</li>
            <li>Add appropriate facing or binding</li>
            <li>Test fit before cutting final fabric</li>
          </ol>
          
          <h4>Advanced Techniques</h4>
          
          <h5>Draping vs. Flat Pattern</h5>
          <ul>
          ...
          <h5>Creating Asymmetrical Designs</h5>
          <ul>
            <li>Different left and right sides</li>
            <li>Requires careful balance and proportion</li>
            <li>Mark clearly which side is which</li>
            <li>Consider how design affects body movement</li>
          </ul>
          
          <h4>Pattern Grading Basics</h4>
          <ul>
          ...
          <h4>Testing and Refining</h4>
          
          <h5>Making a Toile (Muslin)</h5>
          <ul>
            <li>Use inexpensive fabric similar to final fabric</li>
            <li>Test all design elements</li>
            <li>Check ease and movement</li>
            <li>Photograph for reference</li>
          </ul>
          
          <h5>Pattern Refinement Process</h5>
          <ol>
            <li>Identify fit issues in toile</li>
            <li>Mark corrections directly on toile</li>
            <li>Transfer corrections to pattern</li>
            <li>Make second toile if major changes needed</li>
            <li>Document all changes for future reference</li>
          </ol>
          
          <h4>Professional Organization</h4>
          <ul>
            <li>Label all pattern pieces clearly</li>
            <li>Include grain lines, notches, and construction marks</li>
            <li>Store patterns flat or carefully folded</li>
            <li>Keep digital backups of all patterns</li>
    ...
    lessons: [
      {
        ...
        duration: "30 min",
        content: `
          <h3>Elevating Your Work with Professional Seam Finishes</h3>
          <p>The difference between homemade and professionally-made garments often lies in the seam finishes. Master these techniques for couture-quality results.</p>
          
          <h4>Why Seam Finishes Matter</h4>
          <ul>
            <li>Prevent fraying and extend garment life</li>
            <li>Add structural integrity</li>
            <li>Create professional interior appearance</li>
            <li>Improve comfort and wearability</li>
          </ul>
          
          <h4>Basic Seam Finishes</h4>
          ...
          <h4>Intermediate Seam Finishes</h4>
          
          <h5>Turned and Stitched</h5>
          <ul>
          ...
          <h4>Advanced Professional Finishes</h4>
          
          <h5>Hong Kong Seams</h5>
          <ul>
          ...
          <ul>
            ...
            <li><strong>Process:</strong> 
              <ol>
                <li>Stitch wrong sides together at 3/8"</li>
                <li>Trim to 1/8"</li>
                <li>Turn right sides together</li>
                <li>Stitch at 1/4" to enclose raw edges</li>
              </ol>
            </li>
          ...
          <h5>Flat Fell Seams</h5>
          <ul>
            <li><strong>Method:</strong> Strong, flat seam with enclosed edges</li>
            <li><strong>Process:</strong>
              <ol>
                <li>Stitch wrong sides together</li>
                <li>Trim one seam allowance to 1/8"</li>
                <li>Fold longer allowance over shorter</li>
                <li>Topstitch in place</li>
              </ol>
            </li>
          ...
          <h4>Fabric-Specific Considerations</h4>
          
          <h5>Delicate Fabrics</h5>
          <ul>
          ...
          <h4>Tools for Professional Finishing</h4>
          <ul>
          ...
          <h4>Quality Control Tips</h4>
          <ul>
            <li>Test seam finishes on fabric scraps first</li>
            <li>Consider garment care requirements</li>
            <li>Match thread color to fabric or seam finish</li>
            <li>Press seams properly before finishing</li>
      ...
      },
      {
        ...
        duration: "35 min",
        content: `
          <h3>Mastering Professional Buttonholes and Fastenings</h3>
          <p>Perfect buttonholes and fastenings are hallmarks of quality construction. Learn to create durable, beautiful closures that enhance your garments.</p>
          
          <h4>Types of Buttonholes</h4>
          
          <h5>Machine Buttonholes</h5>
          <ul>
          ...
          <h4>Planning Buttonhole Placement</h4>
          
          <h5>Buttonhole Direction</h5>
          <ul>
          ...
          <h4>Machine Buttonhole Techniques</h4>
          
          <h5>Preparation Steps</h5>
          <ol>
            <li>Mark buttonhole placement accurately</li>
            <li>Interface areas for stability</li>
            <li>Test on fabric scraps</li>
            <li>Use appropriate foot and settings</li>
          </ol>
          
          <h5>Executing Perfect Machine Buttonholes</h5>
          <ul>
          ...
          <h4>Bound Buttonholes</h4>
          
          <h5>When to Use</h5>
          <ul>
            <li>Heavy or thick fabrics</li>
            <li>High-end garments</li>
            <li>When machine buttonholes aren't suitable</li>
            <li>Design feature or contrast element</li>
          </ul>
          
          <h5>Construction Method</h5>
          <ol>
            <li>Cut fabric rectangles for lips</li>
            <li>Position and baste to garment</li>
            <li>Stitch rectangle outline</li>
            <li>Cut opening through all layers</li>
            <li>Turn lips to inside</li>
            <li>Press and hand-finish ends</li>
          </ol>
          
          <h4>Hand-Sewn Buttonholes</h4>
          
          <h5>Tools Needed</h5>
          <ul>
            <li>Sharp embroidery scissors</li>
            <li>Fine needles (size 9-11)</li>
            <li>Quality thread (silk or cotton)</li>
            <li>Thimble</li>
          </ul>
          
          <h5>Step-by-Step Process</h5>
          <ol>
            <li>Mark buttonhole length precisely</li>
            <li>Cut opening with sharp scissors</li>
            <li>Work blanket stitch around edges</li>
            <li>Create bar tacks at ends</li>
            <li>Steam lightly to set stitches</li>
          </ol>
          
          <h4>Alternative Fastenings</h4>
          ...
          <h4>Button Selection and Attachment</h4>
          ...
          <h5>Professional Button Attachment</h5>
          <ul>
          ...
          <h4>Professional Tips</h4>
          <ul>
            <li>Always interface buttonhole areas</li>
            <li>Test all techniques on scraps first</li>
            <li>Keep extra buttons attached to garment care label</li>
            <li>Consider garment care when selecting fastenings</li>
    ...
    lessons: [
      {
        ...
        duration: "45 min",
        content: `
          <h3>From Passion to Profit: Launching Your Tailoring Business</h3>
          <p>Transform your tailoring skills into a thriving business. Learn the essential steps to start, legal requirements, and foundation for success.</p>
          
          <h4>Business Planning Fundamentals</h4>
          
          <h5>Defining Your Business Vision</h5>
          <ul>
          ...
          <h4>Legal and Administrative Setup</h4>
          ...
          <h4>Workshop and Equipment Setup</h4>
          ...
          <h5>Essential Equipment Investment</h5>
          <ul>
          ...
          <h4>Building Your Client Base</h4>
          
          <h5>Initial Marketing Strategies</h5>
          <ul>
          ...
          <h5>Initial Consultation Process</h5>
          <ul>
